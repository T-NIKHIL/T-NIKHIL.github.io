...
<div style="display: flex; align-items: flex-start; margin-bottom: -30px; margin-top: -10px;">
  <div style="flex: 1;">
    ...
    <p align='justify'>
      The Acceleration Consortium and Merck KGaA hosted a 
      2-day virtual hackathon on March 27- 28, 2024,
      bringing together scientists to explore, collaborate, and 
      innovate in the field of Bayesian optimization (BO)
      for the physical sciences. 
      The hackathon encouraged participants to select or 
      develop Bayesian optimization algorithms, 
      apply them to benchmarking tasks, 
      design new benchmarks, 
      create instructional tutorials, and 
      describe real-world applications. 
      It had over 100 participants across 69 academic, industry, and
      government organizations located in 59 cities, 19 countries, and 4 continents, this was a global event.
      I led a team that developed BO for high-dimensional, 
      large-scale datasets, 
      specifically applied to the design of Covalent
      Organic Frameworks (COFs) for methane storage [60].
      We developed a novel approach combining unsupervised
      clustering with local Gaussian Process (GP) models to 
      enhance BO efficiency in the high data regime. 
      More details can be found in paper and code.
    </p>
    <p>
      <a href="https://chemrxiv.org/doi/pdf/10.26434/chemrxiv-2025-dzh5z?download=true&redirectToLatest=false">Paper</a>
      <a href="https://github.com/AC-BO-Hackathon/project-localGPs_for_COF">Github</a>
      <a href="https://www.youtube.com/watch?v=iog-07Ekp9g">Video</a>
    </p>
  </div>
  <div style="margin-left: 20px;">
    <img src="/assets/local_GPs.pdf" alt="Article TOC" style="width: 250px; height: 125 px">
  </div>
</div>
<hr style="border: 1px solid black;"/>
<div style="display: flex; align-items: flex-start; margin-bottom: -30px; margin-top: -10px;">
